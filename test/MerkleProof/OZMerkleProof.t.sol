...
import {OZMerkleProof} from "../../src/MerkleProof/OZMerkleProof.sol";

contract OZMerkleProofTest is Test {
    bytes32[] proof_;
    ...
    function testVerify5Elements(bytes32[5] memory proof, bytes32 leaf) public {
        ...
        OZMerkleProof merkleProof5 = new OZMerkleProof(root);
    ...
    function testVerify10Elements(
        ...
        bytes32 root = processProof(proof_, leaf);
        OZMerkleProof merkleProof10 = new OZMerkleProof(root);
    ...
    function testVerify15Elements(
        ...
        bytes32 root = processProof(proof_, leaf);
        OZMerkleProof merkleProof15 = new OZMerkleProof(root);
