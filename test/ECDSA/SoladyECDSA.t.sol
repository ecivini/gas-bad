...
import "../../src/ECDSA/SoladyECDSA.sol";

contract SoladyECDSATest is Test {
    SoladyECDSA public ecdsa;
    bytes32 data;
    bytes32 message;
    address signer;
    uint signerPK;
    ...
    function testRecover() public {
      ...
      address rec = ecdsa.recover(message, signature); 
